...
Apps written with the OpenTok iOS SDK 2.10.0 can interoperate with OpenTok apps
written with the following OpenTok SDKs:

* [OpenTok.js 2.8+](http://tokbox.com/developer/sdks/js/)

* [OpenTok Android SDK
  2.8+](http://tokbox.com/opentok/developer/sdks/android/)

* [OpenTok iOS SDK 2.8+](http://tokbox.com/developer/sdks/ios/)

...
//! Project version number for SpotlightKit.
FOUNDATION_EXPORT double SpotlightKitVersionNumber;

//! Project version string for SpotlightKit.
FOUNDATION_EXPORT const unsigned char SpotlightKitVersionString[];
